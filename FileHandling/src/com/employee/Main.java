...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (yn.equalsIgnoreCase("yes")) {
			boolean udadiya= milf.deleteFile(fName);
			if (udadiya) {
				System.out.println("\n\tUda diya bro!!\n");
			}
			else {
				System.out.println("na ho payega bro!!");
			}
		}
		
		System.out.println("Read karna hai?: "); String han= sc.nextLine();
		if (han.equalsIgnoreCase("yes")) {
			milf.readfile(fName);
		}
